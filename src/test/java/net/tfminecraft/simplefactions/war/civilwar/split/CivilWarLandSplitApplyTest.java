...
class CivilWarLandSplitApplyTest {
	...
	void apply_transfersSettlementOnRebelTile_keepsLoyalCity() {
		...
		when(host.getGuildHandler()).thenReturn(mock(net.tfminecraft.simplefactions.objects.handler.GuildHandler.class));
		when(rebels.getGuildHandler()).thenReturn(mock(net.tfminecraft.simplefactions.objects.handler.GuildHandler.class));
		...
		net.tfminecraft.simplefactions.settlement.handler.SettlementHandler hostCities =
				new net.tfminecraft.simplefactions.settlement.handler.SettlementHandler(host);
		net.tfminecraft.simplefactions.settlement.handler.SettlementHandler rebelCities =
				new net.tfminecraft.simplefactions.settlement.handler.SettlementHandler(rebels);
