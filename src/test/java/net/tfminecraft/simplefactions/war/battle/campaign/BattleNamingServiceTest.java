...
class BattleNamingServiceTest {
	...
	void buildRaidDisplayName_usesInstallationOrdinal() {
		...
		net.tfminecraft.simplefactions.installation.Installation target =
				mock(net.tfminecraft.simplefactions.installation.Installation.class);
	...
	void resolveLocation_usesCountyTitleWhenExactProvinceMisses() {
		...
		net.tfminecraft.simplefactions.settlement.handler.SettlementHandler handler =
				mock(net.tfminecraft.simplefactions.settlement.handler.SettlementHandler.class);
		...
		try (org.mockito.MockedStatic<net.tfminecraft.simplefactions.managers.FactionManager> factions =
						org.mockito.Mockito.mockStatic(net.tfminecraft.simplefactions.managers.FactionManager.class);
				org.mockito.MockedStatic<net.tfminecraft.simplefactions.loaders.TitleLoader> titles =
						org.mockito.Mockito.mockStatic(net.tfminecraft.simplefactions.loaders.TitleLoader.class)) {
			factions.when(net.tfminecraft.simplefactions.managers.FactionManager::getCopy).thenReturn(List.of(faction));
			titles.when(() -> net.tfminecraft.simplefactions.loaders.TitleLoader.getByProvince(44)).thenReturn(county);
