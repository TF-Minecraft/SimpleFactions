...
class BattleLivesServiceTest {
	...
	void countRosterFighters_countsUniqueWarbandMembers() {
		withMockBossBar(bukkit -> {
			...
			net.tfminecraft.simplefactions.war.battle.warband.Warband first =
					mock(net.tfminecraft.simplefactions.war.battle.warband.Warband.class);
			net.tfminecraft.simplefactions.war.battle.warband.Warband second =
					mock(net.tfminecraft.simplefactions.war.battle.warband.Warband.class);
