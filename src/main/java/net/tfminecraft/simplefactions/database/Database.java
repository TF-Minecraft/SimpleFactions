...
public class Database {
    ...
    private HashMap<String, HashMap<String, Double>> serializeSpecificTaxes(net.tfminecraft.simplefactions.objects.handler.TaxHandler taxHandler) {
        HashMap<String, HashMap<String, Double>> result = new HashMap<>();
        
        HashMap<net.tfminecraft.simplefactions.government.proposal.TaxTarget, HashMap<String, Double>> specificTaxes = taxHandler.getSpecificTaxes();
        for (Map.Entry<net.tfminecraft.simplefactions.government.proposal.TaxTarget, HashMap<String, Double>> entry : specificTaxes.entrySet()) {
	...
	public void saveBattle(net.tfminecraft.simplefactions.war.battle.engine.core.Battle battle) {
		if (battle == null) {
			return;
		}
		try {
			...
			net.tfminecraft.simplefactions.database.BattleData data =
					net.tfminecraft.simplefactions.war.battle.persistence.BattleMapper.toData(battle);
			JsonUtil.writeJson(file, data);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void saveWarband(net.tfminecraft.simplefactions.war.battle.warband.Warband warband) {
		if (warband == null) {
			return;
		}
		try {
			...
			net.tfminecraft.simplefactions.database.WarbandData data =
					net.tfminecraft.simplefactions.war.battle.persistence.WarbandMapper.toData(warband);
			JsonUtil.writeJson(file, data);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public java.util.List<net.tfminecraft.simplefactions.war.battle.warband.Warband> loadWarbands() {
		java.util.List<net.tfminecraft.simplefactions.war.battle.warband.Warband> warbands = new ArrayList<>();
		File folder = new File("plugins/SimpleFactions/Warbands");
		...
		for (File file : files) {
			...
			try {
				net.tfminecraft.simplefactions.database.WarbandData data =
						JsonUtil.readJson(file, net.tfminecraft.simplefactions.database.WarbandData.class);
				net.tfminecraft.simplefactions.war.battle.warband.Warband warband =
						net.tfminecraft.simplefactions.war.battle.persistence.WarbandMapper.fromData(data);
				if (warband != null) {
	...
	public java.util.List<net.tfminecraft.simplefactions.war.battle.engine.core.Battle> loadBattles() {
		java.util.List<net.tfminecraft.simplefactions.war.battle.engine.core.Battle> loaded = new ArrayList<>();
		File folder = new File("plugins/SimpleFactions/Battles");
		if (!folder.exists() || !folder.isDirectory()) {
			return loaded;
		}
		...
		for (File file : files) {
			...
			try {
				net.tfminecraft.simplefactions.database.BattleData data =
						JsonUtil.readJson(file, net.tfminecraft.simplefactions.database.BattleData.class);
				net.tfminecraft.simplefactions.war.battle.engine.core.Battle battle =
