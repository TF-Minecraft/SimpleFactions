...
public class WarCreator {
	...
	public List<String> buildMercenaryLore(
		...
		net.tfminecraft.simplefactions.mercenary.company.MercenaryCompany company = engagement.company();
		net.tfminecraft.simplefactions.mercenary.contract.MercenaryContract contract = engagement.contract();
		lore.add(" ");
		...
		lore.add(StringFormatter.formatHex("#a39ba8Home: #d4c9ae"
				+ net.tfminecraft.simplefactions.utils.HomeSettlementNames.of(company.getGuild())));
	...
	public ItemStack createMercenaryItem(
			net.tfminecraft.simplefactions.mercenary.contract.MercenaryEngagements.Engagement engagement,
			String marker) {
		net.tfminecraft.simplefactions.mercenary.company.MercenaryCompany company =
		...
		if (engagement != null && engagement.contract() != null) {
			m.getPersistentDataContainer().set(
					net.tfminecraft.simplefactions.keys.Keys.CONTRACT_ID,
