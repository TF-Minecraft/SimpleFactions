...
import net.tfminecraft.simplefactions.mercenary.company.MercenaryReputationCalculator;
import net.md_5.bungee.api.ChatColor;

/**
 * The three-stage negotiation book, cloned from
 * {@link net.tfminecraft.simplefactions.guild.loans.LoanBook}: editing the terms page
